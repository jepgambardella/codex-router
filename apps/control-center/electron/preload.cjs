...
const routerControl = Object.freeze({
  ...
  setChatGptAccountPoolEnabled: (enabled) => call("setChatGptAccountPoolEnabled", { enabled }),
  setChatGptAccountPoolMode: (mode) => call("setChatGptAccountPoolMode", { mode }),
  setChatGptAccountPoolStrategy: (strategy) => call("setChatGptAccountPoolStrategy", { strategy }),
